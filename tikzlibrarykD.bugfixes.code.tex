% tikzlibrarykD.bugfixes.code.tex
%
...
% Fix by Mark Wibrow, see http://tex.stackexchange.com/a/271024/82186

\begingroup

\catcode`\@=11

\global\def\pgf@@pathcurvebetweentime#1#2#3#4#5#6{%
  \pgfmathparse{#1}%
...
\global\def\pgf@@@pathcurvebetweentime#1#2#3#4{%
\begingroup%
  ...
  %
  % Now get the curve from s to t
  % (NB actually use the reversed curve Q from 0 to 1 - s/t)
  ...
  % Ra = (1-s)^3*Qd + 3*t(1-t)^2*P2 + 3*t^2(1-t)*P3 + t^3*P4.
