...
\mor {ker a} -> A {[near start]}=a:{->,kD/crossing over} A' -> {coker a};
\mor {ker b} -> B {[near start]}=b:{->,kD/crossing over} B' -> {coker b};
\mor {ker c} -> C {[near start]}=c:{->,kD/crossing over} C' -> {coker c};
